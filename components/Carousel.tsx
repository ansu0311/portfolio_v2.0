...
export default function Carousel({
  ...
  return (
    ...
    >
      <div className="bg-slate-300/90 dark:bg-zinc-900/90  w-11/12 sm:w-9/12 h-[40rem] lg:h-[30rem] flex items-center rounded-[1.5rem] mx-auto">
        <div className="flex flex-col lg:flex-row justify-center items-center p-10">
          ...
          <div className="bg-[#ccb2f1] dark:bg-[#342C3F] w-full sm:w-4/5 lg:w-3/5 h-auto rounded-lg -mt-10 lg:-ml-7 p-4 lg:p-10 flex flex-col">
