...
export function ButtonDesign3({ link, text ,target = "_self" }: Props) {
  return (
    <Link
      className={styles.buttonDesign}
      href={link ? link : ""}
    ...
    >
      <button 
      className="bg-transparent border border-white outline-none px-20 pt-1 text-base sm:text-sm md:text-base overflow-hidden rounded-full
  after:absolute after:left-0 after:bottom-0 after:bg-[#c9fd74] after:w-full after:h-full "
      >
        <span
          className="my-auto relative inline-block overflow-hidden after:w-full after:h-full after:inline-block
